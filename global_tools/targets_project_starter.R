...
#' #' Helper Function to access the global_tools path
#' #'
#' #' @param filename       String; Access to the file in the `global_tools` directory
#' #'
#' #' @returns              Path to the file
#' #'
#' #' @examples             `get_global_tool_path("helper_functions.R")`
#' #' @export
...
#' #'
#' #' @examples                - `create_results_wd("cleaning")`
...
#'       con = notebook_path
#'     )
#'     cli_alert_success("Notebook created: ", notebook_path)
#'   } else {
#'     cli_alert_warning("  Notebook already exists: ", notebook_path)
#'   }
#'   
...
#'   }
#'   
#'   cli_alert_success("Saved as: ", basename(path_rds), ", ", basename(path_csv), ", ", basename(path_xlsx))
#'   
...
#' 
#'   if (!dir.exists(path)) {
#'     cli_alert_warning("Directory not found: ", path)
#'     return(list())
#'   }
#' 
#' 
...
#'     cli_alert_warning("No file with the pattern: 'latest_*.rds' found in ", path)
#'     return(list())
#'   }
#' 
#' 
...
#' 
#'   if (detailed) {
#'     cli_alert_success("Imported data sets:")
...
#' 
#'   else {
#'     cli_alert_success("Imported data sets:", paste(names(data_list), collapse = ", "))
#'   }
#' 
#' 
#'   return(data_list)
